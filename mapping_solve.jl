...
model = GmshDiscreteModel("./MoireImages/Moire.msh")
...
lines = Dict("red" => -15:1, "green" => -12:0, "blue" => -11:0)
...
writevtk(Ω,"./MoireImages/results",cellfields=["u"=>u1h, # "uh"=>uh, "urh"=>uh⋅dir["red"],
